import HautevilleHouse.CivilTransportationCanonicalLaneLean.FinalTheorem
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "civil-transportation-canonical-lane",
  theoremObject := "Wardrop equilibrium existence and uniqueness under capacity constraints",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedTransportClosure A
